---
name: audit_code
description: Skill executed by @qa to validate application code and ensure requirements are met without regressions.
---

# Skill: Quality Assurance & Functional Validation
**Assigned to**: @qa
**Model Recommended**: `google/gemini-1.5-flash` (or `anthropic/claude-3-5-sonnet` for complex edge cases)
